...
if($_POST){
 ...
 if(!empty($_FILES['images']['tmp_name'])){
  ...
  mysqli_query("insert into artikel(judul_artikel, isi_artikel, penulis_artikel, photo_artikel)
  values('$judulartikel', '$isiartikel', '$penulisartikel', '$photoartikel')"); 
  
 } else {
  mysqli_query("insert into artikel(judul_artikel, isi_artikel, penulis_artikel)
